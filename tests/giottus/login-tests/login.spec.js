...
test('login test with invalid credentials and correct Email', async ({page}) => {
...
test('login test with invalid Email', async ({page}) => {
...
test('login test with empty Email and password', async ({page}) => {
...
test('login test with Unregistered Email and Password', async ({page}) => {
...
test('login test with invalid OTP', async ({page}) => {
...
test('login test with Expired OTP', async ({page}) => {
